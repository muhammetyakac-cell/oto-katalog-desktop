...
export default function Editor() {
  ...
  const handleSwap = () => {
    ...
    if (isNaN(idx1) || isNaN(idx2) || idx1 < 0 || idx2 < 0 || idx1 >= products.length || idx2 >= products.length) {
      alert('Lütfen geçerli satır numaraları girin!');
      return;
    }
                        ...
                        {editingImageId === product.id ? (
                          <div className="flex flex-col gap-1 w-32">
                            <input 
                              ...
                              placeholder="Yeni Link Girin..." 
                              className="text-[10px] px-2 py-1.5 border border-blue-200 rounded-md bg-blue-50 outline-none w-full font-medium"
                            />
                            <div className="flex gap-1 w-full">
                              <button 
                                ...
                                className="text-[10px] font-bold bg-green-500 text-white px-2 py-1 rounded-md flex-1 hover:bg-green-600 transition"
                              >
                                Güncelle
                              </button>
